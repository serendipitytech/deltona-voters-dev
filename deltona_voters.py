...
def summarize_voting_data(df, selected_elections, selected_voter_status, selected_commission_districts, selected_party):
    ...
    return summary_age, row_totals_age, column_totals_age, df[columns_for_detailed_age], summary_voting_history, row_totals_voting_history, column_totals_voting_history, df[columns_for_detailed_voting_history], all_party_summary
...
def main():
   ...
   # get the summaries and detailed records
    summary_age, row_totals_age, column_totals_age, detailed_age, summary_voting_history, row_totals_voting_history, column_totals_voting_history, detailed_voting_history, all_party_summary = summarize_voting_data(df, selected_elections, selected_voter_status, selected_commission_districts, selected_party)
    ...
    all_party_summary.loc['Column Total'] = all_party_summary.sum()
